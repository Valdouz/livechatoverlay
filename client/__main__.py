...
class LiveChatClient:
    ...
    def _on_upload(self, path: Path, caption: str, target: str, animation: str,
                   trim_start: int = 0, trim_end: int = 0) -> None:
        try:
        ...
        self._api.upload(path, caption, target, animation, trim_start, trim_end)
